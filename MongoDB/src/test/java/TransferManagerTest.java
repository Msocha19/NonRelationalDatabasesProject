...
public class TransferManagerTest {
    ...
    public void createTest() {
        ...
        transferManager.createTranfer(accountManager.find(1), accountManager.find(2), 20, LocalDateTime.now().plusDays(20));
    ...
    public void deleteTest() {
        ...
        transferManager.createTranfer(accountManager.find(1), accountManager.find(2), 20, LocalDateTime.now().plusDays(20));
        transferManager.createTranfer(accountManager.find(2), accountManager.find(3), 20, LocalDateTime.now().plusDays(1));
    ...
    public void findTest() {
        ...
        accountManager.deposit(200, 3);
        transferManager.createTranfer(accountManager.find(1), accountManager.find(2), 20, LocalDateTime.now().plusDays(20));
        transferManager.createTranfer(accountManager.find(2), accountManager.find(3), 10, LocalDateTime.now().plusDays(1));
        Assertions.assertEquals(transferManager.find(1).getAmount(), 20);
